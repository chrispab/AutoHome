...
echo "Copying ~/IOTstack/backups to 192.168.0.110 /mnt/sata_unique1/currentbackups/iotstack_backups"
#rsync -av --delete /home/pi/IOTstack/backups/ pi@192.168.0.110:/mnt/sata_unique1/currentbackups/iotstack_backups
rsync -av --delete ~/IOTstack/backups/ pi@192.168.0.110:/mnt/sata_unique1/currentbackups/iotstack_backups
