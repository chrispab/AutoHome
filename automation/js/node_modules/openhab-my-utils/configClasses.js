...
class PirLightConfig {
  ...
  getTurnOffTimerFunction() {
    return () => {
      ...
      logger.error(
        'ZZ on-OFF Timer expired, lightControlItemName: {}, lightOnOffTimerDurationItemName: {} timerDuration:{}, defaultLightOnOffTimerDurationSecs: {}',
...
class PirSensorConfig {
   ...
   * @param {Array<string>} lightConfigNames - The names of the associated light configurations.
