...
class LightConfig {
  ...
  getLightOffDelayTimerFunction() {
    return () => {
      ...
      logger.debug(
        'L 6 - LightOffDelayTimerFunction: Turning OFF light. Timer expired. lightControlItemName: {}, lightOffDelayTimerDurationItemName: {} timerDuration:{}, defaultLightOffDelayTimerDurationSecs: {}',
