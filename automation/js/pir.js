...
rules.JSRule({
  name: "PIR sensors change",
  description: "PIR sensors change",
  ...
  execute: (data) => {
    ...
    console.error("!!!!!!!!!!!!  pir_occupancy received update itemName : " + data.itemName + ", state: " +items.getItem(data.itemName).state + ", PREV state: " + items.getItem(data.itemName).history.previousState());
